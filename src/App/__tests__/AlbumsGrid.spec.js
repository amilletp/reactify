...
describe('AlbumsGrid', () => {
  ...
  const fetchAlbumsMock = jest.spyOn(fetchActions, 'fetchAlbums').mockImplementation(fetchAlbumsMockImpl) 
  const fetchSongsMock = jest.spyOn(fetchActions, 'fetchSongs').mockImplementation(fetchSongsMockImpl)  
 

  it("renders correctly", done => {

    const wrapper = mount(<Provider store={store}><AlbumsGrid /></Provider>);
